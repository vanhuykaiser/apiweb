...
$word = array(
    "Con bốc được lá 2 ♥ Để Thầy xem...Uhmm, một quân bài rất tốt. Nó báo hiệu rằng con sẽ được người yêu hoặc một người mến mộ ủng hộ và giúp đỡ. Thế nên là an tâm con nhá, có khó khăn gì thì người ấy cũng thông cảm và giúp con mà.",
        ...
        "Con bốc được lá thayboi Để Thầy xem...Phăng teo. Quân bài của số mệnh. Nó không phải là một điềm gở cũng như điềm lành con ạ. Ý nghĩa của nó là chuyện gì đến sẽ đến, nếu con mong chờ một điều gì đó thì cũng không phải sổt ruột. Thầy nghĩ là con hãy để mọi thứ tự nhiên, đừng gượng ép."
);
...
$rdimg = json_encode($thayboi , JSON_UNESCAPED_UNICODE);
