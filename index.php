                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="case-item">
                                        ...
                                        <div>&nbsp;
                                            ...
                                            <button type="button" style="height:30px;width:100px" class="btn btn-primary" onclick="copy('https://Api-vip.zvtuandeeptry14072003zv18.repl.co/game/taixiu')">COPY</button>
                                        </div>
                                    </div>
                                </div>
